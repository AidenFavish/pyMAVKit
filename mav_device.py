...
class MAVDevice:
    ...
    def _connect(self, device_address:str, baud_rate:int, source_system:int, source_component:int) -> utility.mavudp | utility.mavserial:
        ...
        """
        connection = utility.mavlink_connection(device=device_address, baud=baud_rate, source_system=source_system, source_component=source_component, autoreconnect=self.attempt_reconnect)
