...
class TakeoffProtocol(MAVProtocol):
    ...
    """
    def __init__(self, altitude: float, target_system: int = 1, target_component: int = 0):
        super().__init__()
        self.altitude = altitude
        self.target_system = target_system
        self.target_component = target_component

        self.takeoff_msg = Takeoff(self.target_system, self.target_component, self.altitude)
